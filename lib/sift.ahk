...
;{ Sift  https://autohotkey.com/boards/viewtopic.php?t=7302
; Fanatic Guru
; 2015 04 30
; Version 1.00
;
...
;
;   Parameters:
;   1) {Haystack}	String or array of information to search
;
;   2) {Needle}		String providing search text or criteria
;
;	3) {Options}
...
; ===================================================================================================================================================
;
Sift_Regex(Haystack, Needle, Options := "IN", Delimit := "`n",&count:=0)
{
	buildneedle:
	Switch Options, 0
	{
	...
	switch(type(Haystack),0)
	{
		Case 'Object':
		Sifted := []
			for key, Hay in Haystack.OwnProps()
...
{
	if IsSet(Haystack_Matrix)
	&& !IsObject(Haystack_Matrix)
...
{		
	...
	{
		Case 'Object':
			for key, string in Data.OwnProps()
